...
class bvNexusMILP_DR:
    ...
    def _build_variables(self):
        ...
        # Capacity - with TIGHTER bounds for faster solve
        m.n_recip = Var(m.Y, within=NonNegativeIntegers, bounds=(0, 50))
        m.n_turbine = Var(m.Y, within=NonNegativeIntegers, bounds=(0, 20))
        m.bess_mwh = Var(m.Y, within=NonNegativeReals, bounds=(0, 1000))
        m.bess_mw = Var(m.Y, within=NonNegativeReals, bounds=(0, 250))
        m.solar_mw = Var(m.Y, within=NonNegativeReals, bounds=(0, 200))
        m.grid_mw = Var(m.Y, within=NonNegativeReals, bounds=(0, 300))
        ...
        # Unserved energy
        m.unserved = Var(m.T, m.Y, within=NonNegativeReals, bounds=(0, 300))
    ...
    def _build_constraints(self):
        ...
        m.grid_active_con = Constraint(m.Y, rule=lambda m, y: m.grid_mw[y] <= 300 * m.grid_active[y])
